const places = [
  ...
  //-------Rome Hotels
  {
    ...
    coordinates: { lat: 41.9074, lng: 12.4893 },//Hotel Savoy, Rome
  ...
  },
  {
    ...
    coordinates: { lat: 41.9470, lng: 12.4753 },//Marcella Hotel, Rome
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat: 41.9470, lng: 12.4753 },//Otivm Hotel, Rome
    description: "Distinct quality",
  ...
  //-------Abruzzo Attractions
  {
    ...
    coordinates: { lat:41.8088, lng:13.7901 },//National Park, Abruzzo
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat:41.9217, lng:13.8637 },//Lake Scanno, Abruzzo
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat:42.0626, lng:14.3049 },//Castle of Roccascalengo, Abruzzo
    description: "Distinct quality",
  ...
  //-------Abruzzo Hotels
  {
    ...
    coordinates: { lat:42.2039, lng:13.3834 },//Sextantio Albergo Diffuso, Abruzzo
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat:42.3278, lng:13.6912 },//Rifugio della Rocca, Abruzzo
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat:42.3278, lng:13.6912 },//G Hotel Pescara, Abruzzo
    description: "Distinct quality",
  ...
  //-------Sicily Attractions
  {
    ...
    coordinates: { lat:38.1750, lng:12.7335 },//San Vito Lo Capo, Sicily
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat:37.5834, lng:12.8252 },//Selinunte, Sicily
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat:38.1157, lng:13.3615 },//Palermo, Siciliy
    description: "Distinct quality",
  ...
  //-------Sicily Hotels
  {
    ...
    coordinates: { lat:37.518, lng: 15.1731},//Mazzaro Sea Palace,Sicily
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat: 37.0755,  lng: 15.2866 },//Hotel Borgo Pantano, Sicily
    description: "Distinct quality",
  ...
  },
  {
    ...
    coordinates: { lat:37.3278, lng:15.6912 },//Giardini Mon Plaisir, Sicily
    description: "Distinct quality",
  ...
  for (let i = 0; i < places.length; i++) {
    ...
    let infoWindowContentString = `
      <div class="info-window">
        ...
        <h3 style="font-family: Dancing Script, cursive">${place.name}</h3>
        <p>${place.description}</p>
        <p>${place.link}</p>
        <a href="#attraction-${i}">Attractions</a>
      </div>
    `;
